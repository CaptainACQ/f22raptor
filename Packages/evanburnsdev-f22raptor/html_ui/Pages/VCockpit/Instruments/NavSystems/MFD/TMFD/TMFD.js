...
class TMFD extends NavSystemTouch {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        this.pageGroups = [
            new NavSystemPageGroup("PMFD", this, [
                new NavSystemPage("PMFD Home", "PFDHome", new AS3000_TSC_PFDHome()),
                ...
                new NavSystemPage("PMFD Settings", "PFDSettings", new AS3000_TSC_PFDSettings()),
            ]),
            new NavSystemPageGroup("SMFD", this, [
                new NavSystemPage("SMFD Home", "MFDHome", new AS3000_TSC_MFDHome()),
        ...
        //this.topKnobText = this.getChildById("SoftKey_4");
...
class AS3000_TSC_PFDHome extends NavSystemElement {
    init(root) {
        ...
        this.gps.makeButton(this.PFDSettingsButton, this.gps.SwitchToPageName.bind(this.gps, "PMFD", "PMFD Settings"));
    }
    onEnter() {
        ...
        if (currMap == _mapIndex) {
            switch (_mapIndex) {
                case 0:
                    break;
                case 2:
                    this.gps.SwitchToPageName("SMFD", "Weather Selection");
                    break;
            }
        }
        else {
