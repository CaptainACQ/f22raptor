...
;
class HudHSIndicator extends HTMLElement {
    constructor() {
        super();
    ...
    createSVG() {
        ...
        this.root.setAttribute("viewBox", "-178 -15 456 116");
        ...
        }*/
        {
            ...
            this.root.appendChild(this.backgroundCircle);
            {
                ...
                circle.setAttribute("fill", "#000100");
            ...
            {
                let texts = ["N", "03", "06", "E", "12", "15", "S", "21", "24", "W", "30", "33"];
                let angle = 0;
            ...
            }
            {
                ...
                this.headingBug.setAttribute("fill", "#00ff00");
            ...
            if (this.displayStyle != HSIndicatorDisplayType.HUD_Simplified) {
                {
                    ...
                    this.currentTrackIndicator.setAttribute("fill", "#00ff00");
                ...
                }
                {
                    ...
                    arrow.setAttribute("stroke", "#00ff00");
                ...
                }
                {
                    ...
                    this.backgroundCircle.appendChild(this.course);
                    {
                        ...
                        this.beginArrow.setAttribute("fill", "#00ff00");
                        ...
                        this.fromIndicator.setAttribute("fill", "#00ff00");
                        this.fromIndicator.setAttribute("stroke", "#00ff00");
                    ...
                    }
                    {
                        ...
                        this.CDI.setAttribute("fill", "#00ff00");
                        this.course.appendChild(this.CDI);
                    }
                    {
                        this.endArrow = document.createElementNS(Avionics.SVG.NS, "path");
                        this.endArrow.setAttribute("d", "M 51 25 L 49 25 L 49 15 L 45 15 L 50 4 L 55 15 L 51 15 Z");
                        this.endArrow.setAttribute("fill", "#000100");
                        this.endArrow.setAttribute("stroke", "#00ff00");
                        this.endArrow.setAttribute("stroke-width", "1");
                        ...
                        this.toIndicator.setAttribute("fill", "#000100");
                        this.toIndicator.setAttribute("stroke", "#00ff00");
                    ...
                    for (let i = 0; i < circlePosition.length; i++) {
                        ...
                        CDICircle.setAttribute("r", "1");
                        CDICircle.setAttribute("stroke", "#00ff00");
        ...
        }
        {
            ...
            topTriangle.setAttribute("fill", "#000100");
        ...
        }
        {
            ...
            plane.setAttribute("fill", "#00ff00");
            ...
            return;
        {
            ...
            headingRectangle.setAttribute("x", "-60");
            headingRectangle.setAttribute("y", "10");
            headingRectangle.setAttribute("height", "14");
            headingRectangle.setAttribute("width", "50");
            headingRectangle.setAttribute("fill", "#000100");
            ...
            headingLeftText.setAttribute("fill", "#00ff00");
            headingLeftText.setAttribute("x", "-58");
            headingLeftText.setAttribute("y", "21");
            headingLeftText.setAttribute("font-size", "9");
            ...
            headingValue.setAttribute("fill", "#00ff00");
            headingValue.setAttribute("x", "-40");
            headingValue.setAttribute("y", "21");
            headingValue.setAttribute("font-size", "14");
        ...
        }
        {
            ...
            courseRectangle.setAttribute("x", "-60");
            courseRectangle.setAttribute("y", "30");
            courseRectangle.setAttribute("height", "14");
            courseRectangle.setAttribute("width", "50");
            courseRectangle.setAttribute("fill", "#000100");
            ...
            courseLeftText.setAttribute("fill", "#00ff00");
            courseLeftText.setAttribute("x", "-58");
            courseLeftText.setAttribute("y", "41");
            courseLeftText.setAttribute("font-size", "9");
            ...
            courseValue.setAttribute("fill", "#00ff00");
            courseValue.setAttribute("x", "-40");
            courseValue.setAttribute("y", "41");
            courseValue.setAttribute("font-size", "14");
            courseValue.setAttribute("font-family", "Roboto");
            this.courseText = courseValue;
            this.root.appendChild(courseValue);
        }
        {
            let gsRectangle = document.createElementNS(Avionics.SVG.NS, "rect");
            gsRectangle.setAttribute("x", "-120");
            gsRectangle.setAttribute("y", "20");
            gsRectangle.setAttribute("height", "14");
            gsRectangle.setAttribute("width", "50");
            gsRectangle.setAttribute("fill", "#000100");
            this.root.appendChild(gsRectangle);
            if (this.displayStyle == HSIndicatorDisplayType.HUD)
                this.applyHUDStyle(gsRectangle);
            let gsLeftText = document.createElementNS(Avionics.SVG.NS, "text");
            gsLeftText.textContent = "GS";
            gsLeftText.setAttribute("fill", "#00ff00");
            gsLeftText.setAttribute("x", "-118");
            gsLeftText.setAttribute("y", "31");
            gsLeftText.setAttribute("font-size", "9");
            gsLeftText.setAttribute("font-family", "Roboto");
            this.root.appendChild(gsLeftText);
            let gsValue = document.createElementNS(Avionics.SVG.NS, "text");
            gsValue.setAttribute("fill", "#00ff00");
            gsValue.setAttribute("x", "-105");
            gsValue.setAttribute("y", "31");
            gsValue.setAttribute("font-size", "14");
            gsValue.setAttribute("font-family", "Roboto");
            gsValue.textContent = "0";
            this.gsText = gsValue;
            this.root.appendChild(gsValue);
        }
        {
            this.navSourceBg = document.createElementNS(Avionics.SVG.NS, "rect");
            this.navSourceBg.setAttribute("fill", "#000100");
            ...
            this.navSource.setAttribute("fill", "#00ff00");
            ...
            this.flightPhaseBg.setAttribute("fill", "#000100");
            ...
            flightPhase.setAttribute("fill", "#00ff00");
            ...
            this.crossTrackErrorBg.setAttribute("fill", "#000100");
            ...
            crossTrackError.setAttribute("fill", "#00ff00");
        ...
        {
            {
                ...
                this.dmeSource.setAttribute("fill", "#00ff00");
                ...
                this.dmeIdent.setAttribute("fill", "#00ff00");
                ...
                this.dmeDistance.setAttribute("fill", "#00ff00");
            ...
            }
            {
                ...
                botLeftZone.setAttribute("fill", "#000100");
                ...
                this.bearing1Distance.setAttribute("fill", "#00ff00");
                ...
                this.bearing1Ident.setAttribute("fill", "#00ff00");
                ...
                this.bearing1Source.setAttribute("fill", "#00ff00");
                ...
                this.bearing1FixedGroup.appendChild(this.bearing1Source);
                {
                    ...
                    pointer1Main.setAttribute("fill", "#00ff00");
                    ...
                    pointer1Top.setAttribute("fill", "#00ff00");
                    ...
                    pointer1Bot.setAttribute("fill", "#00ff00");
            ...
            }
            {
                ...
                botRightZone.setAttribute("fill", "#000100");
                ...
                this.bearing2Distance.setAttribute("fill", "#00ff00");
                ...
                this.bearing2Ident.setAttribute("fill", "#00ff00");
                ...
                this.bearing2Source.setAttribute("fill", "#00ff00");
                ...
                pointer2.setAttribute("stroke", "#00ff00");
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        ...
        switch (name) {
            ...
            case "ground_speed":
                if (this.gsText) {
                    let gs = fastToFixed(parseFloat(newValue), 0);
                    this.gsText.textContent = gs;
                }
                break;
                ...
                if (this.navSource) {
                    ...
                    switch (newValue) {
                        case "FMS":
                            ...
                            this.toIndicator.setAttribute("fill", "#00ff00");
                            this.fromIndicator.setAttribute("fill", "#00ff00");
                            break;
                        case "VOR1":
                        case "LOC1":
    ...
    update(_deltaTime) {
        ...
        var roundedGroundSpeed = fastToFixed(groundSpeed, 0);
        this.setAttribute("ground_speed", roundedGroundSpeed);
...
customElements.define('glasscockpit-hud-hsi', HudHSIndicator);
//# sourceMappingURL=HudHSIndicator.js.map